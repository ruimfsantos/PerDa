...
/**
 * This class calculates the risk score for an individual column and for entire
 * data store.
 *
...
public class Score {
    ...
    public String getScoreDefinition(final int score) {
        ...
        if (score == 1) {
            scoreDefinition = "Low... It means the average of rows peer columns is less then 100";
        } else if (score == 2) {
            scoreDefinition = "Medium... It means the average of rows peer columns is higher then 100 and less then 1000";
        } else if (score == 3) {
            scoreDefinition = "High... It means the average of rows peer columns is higher then 1000";
        } else {
